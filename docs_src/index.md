...
- [jamgrad](#jamgrad)
  ...
  - [demo](#demo)
    - [basic tensor + autograd demo](#basic-tensor--autograd-demo)
    - [chain rule walkthrough](#chain-rule-walkthrough)
    - [eigenvalue demo](#eigenvalue-demo)
    - [xor neural network demo](#xor-neural-network-demo)
    - [mnist neural network demo](#mnist-neural-network-demo)
